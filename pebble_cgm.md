...
There a mix of faces/apps.
  ...
  * Some work with open source data hubs, typically Android only. For example, [Juggluco](https://github.com/j-kaltes/Juggluco), [Nightscout xDrip+](https://github.com/NightscoutFoundation/xDrip), xDrip, etc.
...
#### Dexcom Share - Pebble Software Graphs
  ...
  * https://github.com/btmx-7/steady-pebble-watchface also supports Nightscout server and Android Juggluco
